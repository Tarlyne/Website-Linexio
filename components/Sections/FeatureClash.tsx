...
const GridPattern: React.FC<{ className?: string }> = ({ className = "" }) => (
  <svg className={`absolute inset-0 w-full h-full opacity-[0.03] pointer-events-none ${className}`} xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <section className="py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          >
            ...
            <div className="space-y-6 flex-1 relative z-10">
              {content.comparison.items.map((item, idx) => (
                <div key={idx} className="flex flex-col gap-1 border-b border-slate-800/50 pb-4 last:border-0">
            ...
            <div className="mt-8 pt-6 border-t border-slate-800/50 flex items-start gap-3 relative z-10">
          ...
          >
            <GridPattern className="text-brand-400 opacity-[0.07]" />
            ...
            <div className="space-y-6 flex-1 relative z-10">
              {content.comparison.items.map((item, idx) => (
                <div key={idx} className="flex flex-col gap-1 border-b border-brand-500/10 pb-4 last:border-0">
            ...
            <div className="mt-8 pt-6 border-t border-brand-500/10 relative z-10">
